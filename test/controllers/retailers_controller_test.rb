...
class RetailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create retailer" do
    assert_difference("Retailer.count") do
      post retailers_url, params: { retailer: { customer_id: @retailer.customer_id, email: @retailer.email, name: @retailer.name } }
    end
  ...
  test "should update retailer" do
    patch retailer_url(@retailer), params: { retailer: { customer_id: @retailer.customer_id, email: @retailer.email, name: @retailer.name } }
